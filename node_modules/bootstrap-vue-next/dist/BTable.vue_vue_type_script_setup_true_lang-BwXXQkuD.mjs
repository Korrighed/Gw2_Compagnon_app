import { defineComponent, computed, openBlock, createElementBlock, normalizeClass, renderSlot, unref, ref, watch, createBlock, withCtx, withDirectives, createVNode, Fragment, renderList, mergeProps, createTextVNode, toDisplayString, createCommentVNode, vShow, normalizeProps, createElementVNode, mergeModels, useSlots, useModel, onMounted, createSlots } from "vue";
import { g as get, s as set } from "./object-DIbMZaP9.mjs";
import { _ as _sfc_main$8 } from "./BTableSimple.vue_vue_type_script_setup_true_lang-Blac9Rkj.mjs";
        ...
        default: withCtx(() => [
          withDirectives(createVNode(_sfc_main$3, {
            ...
            default: withCtx(() => [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(computedFields.value, (field) => {
                    return openBlock(), createBlock(_sfc_main$4, mergeProps({
                      ...
                      default: withCtx(() => [
                        renderSlot(
                          _ctx.$slots,
                          _ctx.$slots[`head(${String(field.key)})`] ? `head(${String(field.key)})` : "head()",
                          {
                            label: field.label,
                            column: field.key,
                            field,
              ...
              _ctx.$slots["thead-sub"] ? (openBlock(), createBlock(_sfc_main$2, { key: 0 }, {
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(computedFields.value, (field) => {
          ...
          unref(props).footClone ? (openBlock(), createBlock(_sfc_main$5, normalizeProps(mergeProps({ key: 0 }, footerProps.value)), {
            ...
            _: 3
          }, 16)) : _ctx.$slots["custom-foot"] ? (openBlock(), createBlock(_sfc_main$5, normalizeProps(mergeProps({ key: 1 }, footerProps.value)), {
            default: withCtx(() => [
          ...
          _ctx.$slots["table-caption"] || unref(props).caption ? (openBlock(), createElementBlock("caption", _hoisted_3$1, [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$1, mergeProps(unref(props), {
        ...
        "custom-body": withCtx((scope) => [
          busyModel.value && _ctx.$slots["table-busy"] ? (openBlock(), createBlock(_sfc_main$2, {
            key: 0,
...
//# sourceMappingURL=BTable.vue_vue_type_script_setup_true_lang-BwXXQkuD.mjs.map
