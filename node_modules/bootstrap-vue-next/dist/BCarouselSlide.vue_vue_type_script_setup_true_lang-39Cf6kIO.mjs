...
import { l as useElementHover, m as useSwipe, o as onKeyStroke } from "./index-CZE037u_.mjs";
import { u as useDefaults } from "./useDefaults-6tLPt05C.mjs";
import { s as carouselInjectionKey } from "./keys-CFfh7DXf.mjs";
import { u as useToNumber, j as useIntervalFn } from "./index-ujIxCC2r.mjs";
import { _ as _sfc_main$2 } from "./BImg.vue_vue_type_script_setup_true_lang-D-lfs4yb.mjs";
...
const _hoisted_2$1 = ["aria-label", "aria-owns"];
const _hoisted_3$1 = ["aria-current", "aria-label", "aria-controls", "aria-describedby", "onClick"];
const _hoisted_4$1 = { class: "visually-hidden" };
const _hoisted_5$1 = { class: "visually-hidden" };
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(props).indicators ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(slides.value.length, (_, i) => {
            ...
            return openBlock(), createElementBlock("button", {
              ...
              "aria-describedby": (_a = slideValues.value) == null ? void 0 : _a[i]._id,
        ...
        unref(props).controls ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          ...
          createElementVNode("button", {
            ...
            createElementVNode("span", _hoisted_5$1, toDisplayString(unref(props).controlsNextText), 1)
          ])
            ...
            hasCaption.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(props).captionTag), { key: 0 }, {
              default: withCtx(() => [
                renderSlot(_ctx.$slots, "caption", {}, () => [
                  ...
                  }, null, 8, _hoisted_2)) : (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(unref(props).caption), 1))
                ])
              ]),
              _: 3
            ...
            hasText.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(props).textTag), { key: 1 }, {
              default: withCtx(() => [
                renderSlot(_ctx.$slots, "text", {}, () => [
                  ...
                  }, null, 8, _hoisted_4)) : (openBlock(), createElementBlock("span", _hoisted_5, toDisplayString(unref(props).text), 1))
                ])
              ]),
              _: 3
            })) : createCommentVNode("", true),
...
//# sourceMappingURL=BCarouselSlide.vue_vue_type_script_setup_true_lang-39Cf6kIO.mjs.map
