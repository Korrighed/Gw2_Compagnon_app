...
declare const _default: <Items>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_expose?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
    props: __VLS_PrettifyLocal<Pick<Partial<{}> & Omit<{
        ...
        onChange?: ((value: Items[]) => any) | undefined;
        "onHead-clicked"?: ((key: string, field: TableField<Items>, event: MouseEvent, isFooter: boolean) => any) | undefined;
        "onRow-clicked"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onRow-dblclicked"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onRow-contextmenu"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onRow-hovered"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onRow-unhovered"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onRow-middle-clicked"?: ((item: Items, index: number, event: MouseEvent) => any) | undefined;
        "onUpdate:sortBy"?: ((sortBy: BTableSortBy[] | undefined) => any) | undefined;
        "onUpdate:busy"?: ((busy: boolean) => any) | undefined;
        "onUpdate:selectedItems"?: ((selectedItems: readonly Items[]) => any) | undefined;
        onFiltered?: ((value: Items[]) => any) | undefined;
        "onRow-selected"?: ((value: Items) => any) | undefined;
        "onRow-unselected"?: ((value: Items) => any) | undefined;
