import { defineComponent, ref, computed, openBlock, createBlock, resolveDynamicComponent, unref, normalizeClass, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createElementBlock, Fragment, normalizeProps, mergeProps } from "vue";
import { u as useAriaInvalid } from "./useAriaInvalid-BTUbGj3Y.mjs";
import { b as isVisible, c as attemptFocus } from "./dom-BUCypNEC.mjs";
import { _ as _sfc_main$4 } from "./BCol.vue_vue_type_script_setup_true_lang-Z6km4tvj.mjs";
import { _ as _sfc_main$1, c as _sfc_main$2, b as _sfc_main$3, a as _sfc_main$5 } from "./BFormValidFeedback.vue_vue_type_script_setup_true_lang-Ch3fU9dp.mjs";
...
import { j as createReusableTemplate } from "./index-CZE037u_.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(isFieldset.value ? "fieldset" : "div"), {
        ...
        class: normalizeClass([unref(stateClass), { "was-validated": unref(props).validated }])
      }, {
        default: withCtx(() => [
          createVNode(unref(ContentTemplate).define, null, {
            default: withCtx(() => [
              _ctx.$slots.invalidFeedback || unref(props).invalidFeedback ? (openBlock(), createBlock(_sfc_main$1, {
                key: 0,
              ...
              _ctx.$slots.validFeedback || unref(props).validFeedback ? (openBlock(), createBlock(_sfc_main$2, {
                key: 1,
              ...
              _ctx.$slots.description || unref(props).description ? (openBlock(), createBlock(_sfc_main$3, {
                key: 2,
          ...
          createVNode(unref(LabelContentTemplate).define, null, {
            default: withCtx(() => [
              _ctx.$slots.label || unref(props).label || isHorizontal.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          isHorizontal.value ? (openBlock(), createBlock(_sfc_main$5, { key: 0 }, {
            default: withCtx(() => [
              ...
              createVNode(_sfc_main$4, mergeProps(contentColProps.value, {
                ref_key: "content",
                ref: content
              }), {
                default: withCtx(() => [
            ...
            createVNode(unref(LabelContentTemplate).reuse),
            !isHorizontal.value && unref(props).floating ? (openBlock(), createElementBlock("div", {
              key: 0,
              ref_key: "content",
              ref: content,
              class: "form-floating"
...
//# sourceMappingURL=BFormGroup.vue_vue_type_script_setup_true_lang-B_p2tnRu.mjs.map
